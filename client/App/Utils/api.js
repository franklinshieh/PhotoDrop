var api = {
  login(username, password) {
    ...
    var url = 'http://159.203.253.125:8000/login';
    return fetch(url, {
      method: 'POST',
  ...
  signup(username, password) {
    var user = { username: username, password: password };
    return fetch('http://159.203.253.125:8000/signup', {
      method: 'POST',
      body: JSON.stringify(user)
    });
  },
  ...
  changePassword(username, password, newPassword) {
    ...
    return fetch('http://159.203.253.125:8000/changePassword', {
      method: 'POST',
      body: JSON.stringify(user)
    });
  },
  ...
  changeUsername(username, newUsername) {
    ...
    return fetch('http://159.203.253.125:8000/changeUsername', {
      method: 'POST',
      body: JSON.stringify(user)
    });
  },
  ...
  checkJWT(JWT, callback) {
    var url = 'http://159.203.253.125:8000/checkJWT/' + JWT;
    fetch(url, {
      method: 'GET',
      headers: {
  ...
  uploadPhoto(data, latitude, longitude, userId, callback) {
    var url = 'http://159.203.253.125:8000/imgUpload';
    // cut data in half
  ...
  fetchPhotos(latitude, longitude, radius, callback) {
    var url = 'http://159.203.253.125:8000/fetchPhotos?lat=' + latitude + '&lon=' + longitude + '&radius=' + radius;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  fetchLocations(latitude, longitude, latdelta, londelta, callback) {
    var url = 'http://159.203.253.125:8000/fetchLocations?lat=' + latitude + '&lon=' + longitude + '&latdelta=' + latdelta + '&londelta=' + londelta;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  fetchUserPhotos(userId, callback) {
    var url = 'http://159.203.253.125:8000/fetchUserPhotos?userId=' + userId;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  fetchUserFavorites(userId, callback) {
    var url = 'http://159.203.253.125:8000/fetchUserFavorites?userId=' + userId;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  incrementViews(url, callback) {
    var url = 'http://159.203.253.125:8000/incrementViews?url=' + url;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  toggleFavorite(userId, url, callback) {
    var url = 'http://159.203.253.125:8000/toggleFavorite?userId=' + userId + '&url=' + url;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
  ...
  getPhotoData(url, userId, callback) {
    var url = 'http://159.203.253.125:8000/getPhotoData?url=' + url + '&userId=' + userId;
    return fetch(url, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
